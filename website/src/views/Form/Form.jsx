...
class UserProfile extends React.Component {
    addArticle= () => {
        ...
        for (var k in this.state) {
            if (k.replace("addArticle_","") !== k) {
                addArticleData[k.replace("addArticle_", "")] = this.state[k]
            }
        }
        this.props.addArticle(addArticleData)
    }
    inputChanged = (evt) => {
        ...
        return (
            ...
            <GridContainer>
                ...
                <Card>
                    ...
                    <CardFooter>
                    <Button color="primary" onClick={this.addArticle}>Add article</Button>
                    </CardFooter>
                </Card>
                </GridItem>
                <GridItem xs={12} sm={12} md={4}>
